...
<<<<<<< HEAD
    ...
    def __init__(self, dataset_path="faces", auto_encode=False):
        """
...
<<<<<<< HEAD
    ...
    def encode_faces(self):
        ...
        Supports both flat files and subdirectories (folders).
        Uses folder name as person's name if images are in subdirectories.
        """
        faces_dir = 'faces'
        ...
        print(f"Encoding faces from {faces_dir}...")
        ...
        for root, dirs, files in os.walk(faces_dir):
            for image in files:
                if image.lower().endswith(('.png', '.jpg', '.jpeg', '.gif')):
                    ...
                    if os.path.abspath(os.path.dirname(image_path)) == os.path.abspath(faces_dir):
                    ...
                    try:
                        ...
                        if len(encodings) > 0:
                            ...
                            print(f"Encoded {name} from {image}")
                        else:
...
<<<<<<< HEAD
    def run_recognition(self):
        ...
        """
        if not self.known_face_encodings:
            print("No faces learned. Please run encode_faces() or load_dataset() first.")
            return
...
if __name__ == "__main__":
    ...
    # Option 1: Auto-encode on initialization
    # fr = FaceRecognition(auto_encode=True)
    
    # Option 2: Manual encoding (recommended for 11 folders)
    fr = FaceRecognition()
